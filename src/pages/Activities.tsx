...
export const Activities: React.FC = () => {
  ...
  const handleCheckSafety = () => {
    alert(
      "AI Safety Check: This feature would analyze the activity and provide safety recommendations based on the patient's current condition and recovery stage."
    );
  };
            ...
            {allowedActivities.map((activity, index) => (
              ...
              >
                <div className="flex items-start gap-2 h-full">
                  <CheckCircle
                    size={16}
                    className="text-[#22C55E] flex-shrink-0 mt-1"
                  />
            ...
            {restrictedActivities.map((activity, index) => (
              ...
              >
                <div className="flex items-start gap-2 h-full">
                  <XCircle
                    size={16}
                    className="text-[#EF4444] flex-shrink-0 mt-1"
                  />
      ...
      <Card>
        ...
        <div className="mt-6 pt-6 border-t border-[#E2E8F0]">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              onClick={() =>
                setActivityQuery("Is it safe to go up and down stairs?")
              }
              className="px-3 py-2 rounded-lg border border-[#E2E8F0] text-[14px] text-[#475569] hover:border-[#2563EB] hover:text-[#2563EB] transition-colors bg-white cursor-pointer"
            >
            ...
            <button
              onClick={() =>
                setActivityQuery("Can I work from home at my desk?")
              }
              className="px-3 py-2 rounded-lg border border-[#E2E8F0] text-[14px] text-[#475569] hover:border-[#2563EB] hover:text-[#2563EB] transition-colors bg-white cursor-pointer"
            >
